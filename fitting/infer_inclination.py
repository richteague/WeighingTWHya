...
with pm.Model() as model:
    ...
    pa_deg = pm.Uniform("pa_deg", lower=0.0, upper=360.)
    #pa_deg = pm.Normal("pa_deg", mu=151., sd=0.1)
...
if nmax is None:
    fn = filename.replace('.fits', '.outer0.5.trace.dat')
else:
